...
class DQNExperiment(BaseExperiment):
    ...
    def get_actions(self):
        return {
            0: [0.0, 0.00, 0.0, False, False],
            1: [0.0, 0.00, 1.0, False, False],
            2: [0.6, 0.00, 0.0, False, False],
            3: [0.3, -0.30, 0.0, False, False],
            4: [0.3, -0.10, 0.0, False, False],
            5: [0.3, 0.30, 0.0, False, False],
            6: [0.3, 0.10, 0.0, False, False]
        }
    ...
    def get_done_status(self, observation, core):
        ...
        return self.done_idle or self.done_falling or self.done_collision
